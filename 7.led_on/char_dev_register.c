...
static int cdev_release(struct inode *inode, struct file *filp)
{
    ...
    /* 可以在这里添加释放资源的代码，如果需要的话 */
    (void)device_handle; /* 避免未使用变量警告 */
...
static int __init char_dev_register_init(void)
{
    ...
    /* 6.映射IO地址 */
    /* 映射PMU GRF基地址 */
    pmu_grf_base_addr = ioremap(PMU_GRF_MUX_CONTROL_REG_BASE_ADDR, 0x100);
    ...
    /* 映射GPIO_0基地址 */
    gpio_0_base_addr = ioremap(GPIO_0_BASE_ADDR, 0x100);
    if (!gpio_0_base_addr)
    {
        ret = -ENOMEM;
